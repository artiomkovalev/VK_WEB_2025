...
urlpatterns = [
    ...
    path('question/<int:question_id>/vote/', views.QuestionVoteView.as_view(), name='vote_question'),
    path('answer/<int:question_id>/vote/', views.AnswerVoteView.as_view(), name='vote_answer'),
